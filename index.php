...
<div class="container">
    ...
    <?php if ( '1' == $error): ?>
        <div class="row">
            <div class="column column-60 column-offset-20">
               <h3 style="color:red; text-align: center;"> <b>Oops!! Roll Number Already Exits 🙂</b> </h3>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if ( 'add' == $task ): ?>
        <div class="row">
            <div class="column column-60 column-offset-20">
                <form action="/php_program/crud/index.php?task=add" method="POST">
